            ...
            <div class="content-wrapper">
                ...
                <div class="row">
                    ...
                    <div class="col-12 grid-margin">
                        <div class="card">
                            <div class="card-body">
                                <div class="table-responsive">
                                    ...
                                    <!--                                        }-->
                                    <!--                                    </style>-->
                                    <form method="post" enctype="application/x-www-form-urlencoded" action="/companiesOperation1">
                                        <table class="table">
                                            <thead>
                                            <tr>
                                                <th>ID</th>
                                            ...
                                            <?php foreach ($companiesAll as $element): ?>
                                                <tr>
                                                    <td>
                        ...
                        <form method="post" enctype="application/x-www-form-urlencoded" action="/companiesOperation2">
                                ...
                                <div class="card-body">
                                    ...
                                    -->                            <form class="forms-sample">
                                        <div class="form-group">
                                            <input name="id" value="<?php echo $curCompany->id ?>" type="hidden" class="form-control" id="exampleInputUsername1" placeholder="ID">
                                        </div>
                                        <form class="forms-sample">
                                            <div class="form-group">
                                                <label for="exampleInputUsername1">Название ЮЛ</label>
                                                <input name="name" value="<?php echo $curCompany->name ?>" type="text" class="form-control" id="exampleInputUsername1" placeholder="Название ЮЛ">
                                            </div>
                                            <div class="form-group">
                                                <label for="exampleInputUsername1">ИНН</label>
                                                <input name="inn" value="<?php echo $curCompany->inn ?>" type="text" class="form-control" id="exampleInputUsername1" placeholder="ИНН">
                                            </div>
                                            <div class="form-group">
                                                <label for="exampleInputUsername1">КПП</label>
                                                <input name="kpp" value="<?php echo $curCompany->kpp ?>" type="text" class="form-control" id="exampleInputUsername1" placeholder="КПП">
                                            </div>
